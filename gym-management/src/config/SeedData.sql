...
BEGIN
  ...
  INSERT INTO shifts (
    ...
    ('Ca 1', '05:00:00', '09:00:00', NOW() - INTERVAL '10 hours', NOW() - INTERVAL '6 hours', 500000, 870000, uuid_tramanh, 'closed', 'Ca sang da chot'),
    ('Ca 2', '09:00:00', '13:00:00', NOW() - INTERVAL '2 hours', NULL, 400000, NULL, uuid_phu, 'open', 'Ca hien tai');
  ...
  INSERT INTO member_logs (member_id, staff_id, action, details, note) VALUES
    (v_member_1, uuid_tramanh, 'CREATE', jsonb_build_object('fee', 500000), 'Them hoi vien moi'),
    (v_member_2, uuid_phu, 'RENEW', jsonb_build_object('fee', 1200000, 'package_type', 3), 'Gia han hoi vien');
  ...
  IF uuid_nhu IS NOT NULL AND uuid_phu IS NOT NULL THEN
